...
def main():
    path = "./"
    filelist = ["diep_all_touch.csv", "pubg_all_touch.csv"]
    usrID = 1
    for file in filelist:
        ...
        for i in df.values:
            ...
            if len(prev_data) == SEQ_LEN:
                ...
                for jj in [[mean_x_speed, mean_y_speed, mean_speed, mean_x_acc, mean_y_acc, mean_acc, mean_jerk, mean_tan, mean_touch_major, mean_touch_minor,
                            std_x_speed, std_y_speed, std_speed, std_x_acc, std_y_acc, std_acc, std_tan, std_jerk, std_touch_major, std_touch_minor,
                            min_x_speed, min_y_speed, min_speed, min_x_acc, min_y_acc, min_acc, min_tan, min_jerk, min_touch_major, min_touch_minor,
                            max_x_speed, max_y_speed, max_speed, max_x_acc, max_y_acc, max_acc, max_tan, max_jerk, max_touch_major, max_touch_minor, usrID]]:  # 44 values
